<x-guest-layout>
    <x-authentication-card>
        ...
        <x-slot name="subtitle">Check your inbox for a verification link before using the merchant console.</x-slot>
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <div>
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    ...
                    <button type="submit" class="ms-2 text-sm font-medium text-indigo-600 hover:text-indigo-500">
                        {{ __('Log Out') }}
                    </button>
                </form>
            </div>
